...
(function(e){e.Observer=function(a){return e.ObjectFactory({_extends_:function(){return{update:function(a){if(typeof this[a.eventName]==="function")try{this[a.eventName](a.data)}catch(b){}}}},_public_:a})}})(Pattern);
